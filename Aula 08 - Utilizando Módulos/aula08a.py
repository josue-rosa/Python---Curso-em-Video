...
# Também é possível importar diretamente os módulos sqrt, ceil e floor
...
import random
""" Exibir um valor randomico entre 0 e 1
num = random.random()
print(num)
"""

""" Exibir um valor randomico INTEIRO entre 1 e 10
